  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      ...
      >
        <motion.div
          animate={{
            borderColor: selectedRole === 'client' ? 'rgba(37, 99, 235, 0.3)' : 'rgba(212, 175, 55, 0.2)'
          }}
          transition={{ duration: 0.3 }}
        >
          <Card className={`shadow-2xl transition-colors duration-300 ${
            selectedRole === 'client' ? 'border-blue-500/30' : 'border-gold/20'
          }`}>
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <div>
                        <p className={`font-semibold text-sm ${isSelected ? option.color : 'text-gray-700'}`}>
                          {option.title}
                        </p>
              ...
              >
                ...
                {selectedRole === 'owner' ? (
                  <div className="text-xs text-gray-600">
                    <p>Email: <code className="bg-white px-1 py-0.5 rounded">admin@barberpro.com</code></p>
                    <p>Senha: <code className="bg-white px-1 py-0.5 rounded">admin123</code></p>
                  </div>
                ) : (
                  <div className="text-xs text-gray-600">
                    <p>Email: <code className="bg-white px-1 py-0.5 rounded">cliente@email.com</code></p>
                    <p>Senha: <code className="bg-white px-1 py-0.5 rounded">cliente123</code></p>
                  </div>
                )}
              </motion.div>
            </AnimatePresence>
